...
| MS4 | States are numbered by the latency of their longest runs across rows: (median onset + median offset) / 2 (reference rule; on the GN K5 and metaphor K3–K8 data it gives the same order as the median of the midpoints); states that never occur come last. | D | Code |

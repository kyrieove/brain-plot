...
| K1 | `kind: "erp"`: waveforms only, the combo waveform column over the full width; L3, L5–L10 and T1–T3 apply; one letter per panel inside the canvas; panels keep ≥ 13 mm between them for facet label, ROI title and letter. (User rule, 2026-09-25.) | U | Code |
